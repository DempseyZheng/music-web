...
xcsoft.tipsHtml = function(b, c) {
	var a = $(".xctips");
	c = c || "info";
	0 == a.length ? (a = document.createElement("div"), a.className = "xctips " + c, this.dom = $(a), this.dom.css(this.tipsCss), a.style.top = "-" + this.tipsCss.height, a.style.height = this.tipsCss.height, a.style.lineHeight = this.tipsCss.height, a.innerHTML = b, $(".xctips-container").append(this.dom)) : (a.html(b), a.attr("class", "xctips " + c), this.dom = a)
};
